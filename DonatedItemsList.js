...
function DonatedItemsList() {
  ...
  return (
    <div>
      <div className="header">
        ...
        <div className="search-bar">
          <input
            ...
            style={{ marginRight: '10px' }} // Adding margin-right to create space
          />
      ...
      <div style={{ textAlign: 'right', marginRight: '10px', marginTop: '10px' }}> {/* Adding margin to the top and right */}
        <div style={{ float: 'right', marginBottom: '20px' }}> {/* Aligning slightly left from the right of the page and adding margin-bottom */}
      ...
      <div style={{ margin: '10px 0 20px 0' }}> {/* Adding margin below the button */}
